...
import { useInitialiseCategory, useUpdateCategoryItems} from "../../actionHooks/categoryActionHooks";
import Category from "./Category";
import "./Category.css";

const CategoryContainer = ({ match: { params: { category } } }) => {
  ...
  useEffect(() => {
    ...
    return (() => {
      localStorage.setItem(`${savedState.current.category}State`, JSON.stringify(savedState.current));
    })
  }, []);
